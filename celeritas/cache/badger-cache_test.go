...
func TestBadgerCache_Has(t *testing.T) {
	...
	if !inCache {
		t.Error("'foo' NOT FOUND in cache when it should have been.")
	}
...
func TestBadgerCache_Forget(t *testing.T) {
	...
	if inCache {
		t.Error("'foo' found in cache when it shouldn't have.")
	}
}
...
func TestBadgerCache_Empty(t *testing.T) {
	...
	if inCache {
		t.Error("'alpha' found in cache when it shouldn't have.")
	}
}
